...
subtitle: "Zurich's exploding snowman is folklore, not forecasting. Record summers (avg >19°C) occur across all burn durations from 4 to 60 minutes." 
...
![Scatter plot showing burn duration versus average summer temperature for Zurich's Sechseläuten festival (1923–2025). Record hot summers (above 19°C, shown as large red points) are scattered across the entire range of burn durations—from 4 to 60 minutes—demonstrating no relationship between how quickly the Böögg explodes and summer temperatures. The correlation is +0.19, opposite to what folklore predicts.](tt_2025_48.png){#fig-1}

...
share:
  ...
  description: "Dive into the magical world of D&D! 🎲✨ Discover how spellcasting classes balance between versatility and specialization, from Wizards' vast spell libraries to Clerics' unique divine magic. A data visualization story comparing spell access and exclusive abilities across character classes. #DnD #DataViz #rstats"
  twitter: true
  linkedin: true
  email: true
  facebook: false

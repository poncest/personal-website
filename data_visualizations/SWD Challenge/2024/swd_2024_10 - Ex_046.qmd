...
I have provided a link to my GitHub repository so readers can access the source code and data behind this visualization. The complete Quarto document, data processing scripts, and additional resources used in this project are there. This will allow you to explore how the analysis was done and even adapt the methods for your own use.

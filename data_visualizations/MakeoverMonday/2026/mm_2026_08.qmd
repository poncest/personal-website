...
![A two-panel time series (2001–2024) exploring Science Foundation Ireland's legacy. The top panel shows annual grant commitments as a teal area chart, peaking at €469M in 2019 before a sharp 2024 drop reflecting SFI's July dissolution. The bottom panel shows new institutions funded each year as a bar chart, with 2013–2017 highlighted in teal, during which 59 new institutions entered the ecosystem. Together, the panels argue that while SFI's funding fluctuated, its institutional reach grew steadily until the end. Note: totals reflect commitments by grant start year, not annual expenditure; 2024 is a partial year.](mm_2026_08.png){#fig-1}

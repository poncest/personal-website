...
image: "thumbnails/rwfd_dashboard.png"
format:
  html:
    toc: true
    toc-depth: 5
...
![RWFD Supply Chain Dashboard: An interactive Shiny application featuring logistics KPIs, cost analysis, and warehouse performance metrics. The dashboard providesinsights into shipping costs, warehouse utilization, and service level performance.](sa_2025-02-16.png){#fig-1}
...
#### 3. __Technical Implementation__ 
